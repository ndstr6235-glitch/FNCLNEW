...
import { getClientDetail, deleteClient, type ClientDetail } from "@/app/actions/crm/clients";
...
import DrawerTabTickets from "./drawer-tab-tickets";
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <aside
        ...
        className={cn(
          "absolute right-0 top-0 bottom-0 bg-surface flex flex-col overflow-hidden",
