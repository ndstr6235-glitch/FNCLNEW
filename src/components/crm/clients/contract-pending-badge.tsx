...
export default function ContractPendingBadge({ compact = false }: { compact?: boolean }) {
  return (
    <span
      className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-ruby/15 border border-ruby text-ruby text-[10px] font-bold uppercase tracking-wide whitespace-nowrap animate-pulse"
