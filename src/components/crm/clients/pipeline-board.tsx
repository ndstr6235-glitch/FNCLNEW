...
import { PIPELINE_STAGES, SCORE_META } from "@/lib/crm/constants";
import { updateClientStage } from "@/app/actions/crm/clients";
import type { PipelineClient } from "@/app/actions/crm/clients";
