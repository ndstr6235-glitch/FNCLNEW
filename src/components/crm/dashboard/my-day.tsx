...
import { markTaskDone } from "@/app/actions/crm/my-day";
import type { DayTask, FollowUp } from "@/app/actions/crm/my-day";
          ...
          <div className="space-y-1">
            {followUps.map((fu) => (
              ...
              >
                ...
                <a
                  href={`/clients?open=${fu.clientId}`}
                  className="flex-1 min-w-0 group"
                >
                  <p className="text-sm font-medium text-text truncate group-hover:underline">
                    {fu.name}
                  </p>
                  <p className="text-xs text-text-mid">
