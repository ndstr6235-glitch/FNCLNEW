...
import { globalSearch, type SearchResult } from "@/app/actions/crm/search";
import { NAV_ITEMS } from "@/lib/crm/constants";
...
const NAV_EMOJI_MAP: Record<string, string> = {
  dashboard: "📊",
  calling: "📞",
  clients: "👥",
  tickets: "🎫",
