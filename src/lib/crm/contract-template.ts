...
<div class="doc-wrapper" style="max-width:800px; margin:0 auto; background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 4px 24px rgba(26,47,74,0.08);">
  ...
  <div style="background:linear-gradient(135deg,#1a2f4a 0%,#0c1829 100%); padding:28px 40px; display:flex; align-items:center; justify-content:space-between;">
    <div style="display:flex; align-items:center; gap:14px;">
      ...
      <div>
        <div style="font-size:22px; font-weight:700; color:#ffffff; letter-spacing:1px;">Alexandr Puškin, s.r.o.</div>
  ...
  <div style="padding:40px 44px;">
    ...
    <div style="margin-bottom:28px;">
      ...
      <div style="background:#f8f9fc; border-radius:10px; padding:20px 24px; border-left:3px solid #1a2f4a;">
        ...
        <table style="width:100%; font-size:14px; color:#1a1f2e; border-collapse:collapse;">
          <tr><td style="padding:3px 0; width:180px; color:#556073;">Obchodní firma:</td><td style="padding:3px 0; font-weight:600;">Alexandr Puškin, s.r.o.</td></tr>
          <tr><td style="padding:3px 0; color:#556073;">IČO:</td><td style="padding:3px 0;">26740788</td></tr>
          <tr><td style="padding:3px 0; color:#556073;">Sídlo:</td><td style="padding:3px 0;">Rybná 716/24, Staré Město, 110 00 Praha 1</td></tr>
          <tr><td style="padding:3px 0; color:#556073;">Jednající:</td><td style="padding:3px 0;">Lukáš Salamánek, jednatel</td></tr>
          <tr><td style="padding:3px 0; color:#556073;">Bankovní spojení:</td><td style="padding:3px 0;"></td></tr>
        </table>
      </div>
    </div>
    ...
    <div style="margin-bottom:28px;">
      <div style="display:flex; align-items:center; gap:10px; margin-bottom:16px;">
        ...
        <h2 style="font-size:17px; font-weight:700; color:#1a2f4a; margin:0;">Práva a povinnosti Věřitele</h2>
      </div>
      <div style="padding:0 10px;">
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>6.1</strong> Věřitel je povinen poskytnout Dlužníkovi peněžní prostředky ve výši jistiny dle čl. 2.1 této smlouvy, a to nejpozději do 5 pracovních dnů ode dne podpisu této smlouvy oběma smluvními stranami.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>6.2</strong> Věřitel je oprávněn požadovat po Dlužníkovi řádné a včasné plnění veškerých závazků vyplývajících z této smlouvy, zejména výplatu úroků ve sjednaných termínech a vrácení jistiny v termínu dle čl. 3.1.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>6.3</strong> Věřitel je oprávněn ověřit u Dlužníka stav úhrad a aktuální výši jeho závazku z této smlouvy, a to nejvýše jednou za kalendářní čtvrtletí na základě písemné žádosti.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>6.4</strong> Věřitel je povinen sdělit Dlužníkovi bez zbytečného odkladu jakoukoliv změnu svých identifikačních nebo platebních údajů, zejména změnu bankovního spojení.</p>
      </div>
    </div>
    ...
    <div style="margin-bottom:28px;">
      <div style="display:flex; align-items:center; gap:10px; margin-bottom:16px;">
        ...
        <h2 style="font-size:17px; font-weight:700; color:#1a2f4a; margin:0;">Práva a povinnosti Dlužníka</h2>
      </div>
      <div style="padding:0 10px;">
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>7.1</strong> Dlužník je povinen vrátit Věřiteli celou poskytnutou jistinu řádně a včas v termínu dle čl. 3.1, a to na bankovní účet Věřitele uvedený v záhlaví této smlouvy.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>7.2</strong> Dlužník je povinen vyplácet Věřiteli úroky ve výši a četnosti dle čl. IV této smlouvy, vždy nejpozději do 15. dne kalendářního měsíce za období uplynulé.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>7.3</strong> Dlužník je povinen použít poskytnutou zápůjčku výhradně v souladu s účelem sjednaným v čl. 2.2 této smlouvy.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>7.4</strong> Dlužník je povinen bez zbytečného odkladu, nejpozději však do 7 kalendářních dnů, písemně informovat Věřitele o zahájení insolvenčního řízení, exekučního řízení nebo o podstatném zhoršení své finanční situace ohrožující plnění závazků z této smlouvy.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>7.5</strong> Dlužník je oprávněn kdykoliv splatit zápůjčku zcela nebo zčásti i před termínem splatnosti, a to bez sankce. O předčasné splátce je Dlužník povinen Věřitele písemně informovat nejméně 15 kalendářních dnů předem.</p>
      </div>
    </div>
    ...
    <div style="margin-bottom:28px;">
      <div style="display:flex; align-items:center; gap:10px; margin-bottom:16px;">
        <div style="width:32px; height:32px; background:linear-gradient(135deg,#d4af37,#b8962d); border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:13px; font-weight:700; color:#fff;">VIII</div>
        <h2 style="font-size:17px; font-weight:700; color:#1a2f4a; margin:0;">Prohlášení Dlužníka</h2>
      </div>
      <div style="padding:0 10px;">
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>8.1</strong> Dlužník prohlašuje, že je oprávněn tuto smlouvu uzavřít a plnit závazky z ní vyplývající.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>8.2</strong> Dlužník prohlašuje, že vůči němu není vedeno insolvenční řízení ani exekuční řízení, a že je schopen plnit své závazky řádně a včas.</p>
      </div>
    </div>
    ...
    <div style="margin-bottom:36px;">
      <div style="display:flex; align-items:center; gap:10px; margin-bottom:16px;">
        <div style="width:32px; height:32px; background:linear-gradient(135deg,#d4af37,#b8962d); border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:14px; font-weight:700; color:#fff;">IX</div>
        <h2 style="font-size:17px; font-weight:700; color:#1a2f4a; margin:0;">Závěrečná ustanovení</h2>
      </div>
      <div style="padding:0 10px;">
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>9.1</strong> Tato smlouva nabývá platnosti a účinnosti dnem podpisu oběma smluvními stranami.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>9.2</strong> Smlouva je vyhotovena ve dvou stejnopisech, z nichž každá strana obdrží po jednom.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>9.3</strong> Práva a povinnosti touto smlouvou výslovně neupravené se řídí příslušnými ustanoveními občanského zákoníku.</p>
        <p style="font-size:14px; margin:0 0 10px 0;"><strong>9.4</strong> Smluvní strany prohlašují, že si smlouvu přečetly, jejímu obsahu rozumí a na důkaz své svobodné vůle připojují své podpisy.</p>
      </div>
    </div>

    <!-- Signatures — VĚŘITEL stays blank (client fills by hand), DLUŽNÍK pre-filled -->
    <div style="display:flex; gap:40px; margin-top:40px;">
      <div style="flex:1; text-align:center;">
        <p style="font-size:13px; color:#556073; margin:0 0 6px 0;">V Praze dne _______________</p>
      ...
      <div style="flex:1; text-align:center;">
        ...
        <div style="border-top:2px solid #dfe3ea; margin:40px 20px 12px 20px; padding-top:12px;">
          <p style="font-size:14px; font-weight:600; color:#1a2f4a; margin:0;">Lukáš Salamánek</p>
          <p style="font-size:12px; color:#556073; margin:4px 0 0 0;">Dlužník – Alexandr Puškin, s.r.o., jednatel</p>
        </div>
      </div>
    </div>
